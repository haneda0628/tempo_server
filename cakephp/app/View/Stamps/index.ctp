<div class="stamps index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('member_id', 'メンバー'); ?></th>
			<th><?php echo $this->Paginator->sort('stamped', 'スタンプ日時'); ?></th>
    ...
    <tr style="text-align:center">
		...
		<td>
			<?php echo $this->Html->link($stamp['Member']['id'].' ('. $stamp['Member']['firstname'].' '. $stamp['Member']['lastname']. ')', array('controller' => 'members', 'action' => 'view', $stamp['Member']['id'])); ?>
		</td>
