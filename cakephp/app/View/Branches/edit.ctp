...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Branch.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Branch.id')))); ?></li>
